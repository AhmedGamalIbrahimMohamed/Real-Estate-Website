import { ResetPasswordEmployeeComponent } from './reset-password-employee/reset-password-employee.component';
import { ForgetPasswordEmployeeComponent } from './forget-password-employee/forget-password-employee.component';
...
const routes: Routes = [
  ...
  { path: 'ForgetPasswordE', component: ForgetPasswordEmployeeComponent }, // done forget
  { path: 'resetE', component: ResetPasswordEmployeeComponent }, //done reset
  // EMPLOYEE
